...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/sedmonsond/stratmc",
    ...
    "navbar_end": ["navbar-icon-links.html"], # "search-field.html", , "theme-switcher.html"
...
#html_sidebars = {"learn": [], "**": ["sidebar-nav-bs.html"]}
...
man_pages = [(master_doc, "stratmc", "StratMC Documentation", [author], 1)]
